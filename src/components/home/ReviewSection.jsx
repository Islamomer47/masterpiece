          ...
          <div className="grid md:grid-cols-3 md:gap-6 max-md:gap-10 max-md:justify-center mt-16">
            <div className="max-w-[350px] h-auto shadow-[0_2px_22px_-4px_rgba(93,96,127,0.2)] lg:p-8 p-4 rounded-md bg-white relative">
              ...
              <div className="mt-6">
                <p className="text-sm leading-relaxed">
                  ...
                  Placeat adipisci, cupiditate excepturi, dolorum ipsum eius
                  explicabo alias inventore vitae, quo fuga nisi veniam enim.
                  Hic dolores nostrum facilis corrupti placeat!
                </p>
              </div>
            </div>
            <div className="max-w-[350px] h-auto shadow-[0_2px_22px_-4px_rgba(93,96,127,0.2)] lg:p-8 p-4 rounded-md bg-white relative">
              ...
              <div className="mt-6">
                <p className="text-sm leading-relaxed">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Assumenda delectus fuga quaerat molestiae. Molestias sint quia
                  sapiente repudiandae a facilis consectetur velit eveniet rerum
                  nesciunt, quasi deleniti. Similique, neque animi!
                </p>
              </div>
            </div>{" "}
            <div className="max-w-[350px] h-auto shadow-[0_2px_22px_-4px_rgba(93,96,127,0.2)] lg:p-8 p-4 rounded-md bg-white relative">
            ...
            {/* <div className="max-w-[350px] h-auto shadow-[0_2px_22px_-4px_rgba(93,96,127,0.2)] lg:p-8 p-4 rounded-md bg-white relative">
              ...
              <div className="mt-6">
                <p className="text-sm leading-relaxed">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Fugiat tempora ab distinctio in nisi, at maxime assumenda
                  provident reiciendis velit dignissimos eius itaque sequi nam
                  laboriosam soluta fuga ad repellat?
                </p>
              </div>
            </div> */}
          </div>
